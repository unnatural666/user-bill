...
<div style="width: 100% ;height: auto">
  <div>
    <table style=" line-height: 35px;width: 900px; margin-left: -10px">
      <tr>
        <th style="padding-left: 0px ;font-size: 16px">承兑对象</th>
        <td>商票</td>
        <td>银票</td>
        <td>国股</td>
        <td>三农</td>
      ...
      <tr>
        <th style="padding-left: 0px ;font-size: 16px">票面金额</th>
        <td>10万以下</td>
        <td>10-100万</td>
        <td>100万以上</td>
        <td>500万以上</td>
      ...
      <tr>
        <th style="padding-left: 0px ;font-size: 16px">剩余天数</th>
        <td>30天内</td>
        <td>60-90天</td>
        <td>190-180天</td>
        <td>180-360天</td>
      ...
      <tr >
        <th style="padding-left: 0px ;font-size: 16px">有无瑕疵</th>
        <td>有瑕疵</td>
        <td>无瑕疵</td>

      </tr>
      <tr >
        <th style="padding-left: 0px ;font-size: 16px">成交信用</th>
        <td>良好</td>
        <td>一般</td>
        <td>优秀</td>
      ...
      <tr>
        <th style="padding-left: 0px ;font-size: 16px">最低票价</th>
